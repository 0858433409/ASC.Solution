    ...
    public class MasterDataCacheOperations : IMasterDataCacheOperations
    {
        ...
        public async Task CreateMasterDataCacheAsync()
        {
            ...
            await _cache.SetStringAsync(
                MasterDataCacheName,
                JsonConvert.SerializeObject(masterDataCache)
            );
        }

        public async Task<MasterDataCache> GetMasterDataCacheAsync()
        {
            /*var cacheString = await _cache.GetStringAsync(MasterDataCacheName);
            return JsonConvert.DeserializeObject<MasterDataCache>(cacheString);*/
